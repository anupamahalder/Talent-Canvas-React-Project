    ...
    return (
        <div className="min-h-screen mx-auto">
            ...
            <div className="relative">
                ...
                <div className="absolute flex justify-center items-center top-0 h-full w-full bg-gradient-to-r from-[#0d0d0d59] via-[#080808bd] to-[#0d0d0d59]">
                    <div className="mx-auto justify-center">
                        ...
                        <div className="md:flex gap-2 px-2 mx-auto justify-center items-center w-92 md:w-full">
                            <form onSubmit={hanldeSearch} className="mx-auto">
                                ...
                                <button className="rounded-md outline-offset-1 bg-[#e64f34] w-20 md:w-32 py-2 lg:py-3 px-3 lg:px-8 uppercase font-semibold text-white hover:bg-[#b64632]">Search</button>
                            </form>
                        </div>
                        </div>
                    </div>
            ...
            <div className="mb-10 mx-auto">
                <h1 className="my-10 mx-auto drop-shadow-lg text-[#FF6348] text-center text-3xl md:text-4xl
