...
const Register = () => {
    ...
    return (
        <div className="md:flex justify-center items-center mx-auto min-h-screen py-20 lg:px-10">
            ...
            <div className="-mb-2 flex justify-center mx-auto w-3/5 md:w-1/2">
